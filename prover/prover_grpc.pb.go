...
const (
	Prover_Prove_FullMethodName = "/prover.Prover/Prove"
	Prover_Spec_FullMethodName  = "/prover.Prover/Spec"
)
...
type ProverClient interface {
	...
	Spec(ctx context.Context, in *ProverSpecRequest, opts ...grpc.CallOption) (*ProverSpecResponse, error)
}
...
func (c *proverClient) Spec(ctx context.Context, in *ProverSpecRequest, opts ...grpc.CallOption) (*ProverSpecResponse, error) {
	out := new(ProverSpecResponse)
	err := c.cc.Invoke(ctx, Prover_Spec_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ProverServer interface {
	...
	Spec(context.Context, *ProverSpecRequest) (*ProverSpecResponse, error)
...
func (UnimplementedProverServer) Spec(context.Context, *ProverSpecRequest) (*ProverSpecResponse, error) {
...
func _Prover_Spec_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ProverSpecRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProverServer).Spec(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Prover_Spec_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProverServer).Spec(ctx, req.(*ProverSpecRequest))
	}
	return interceptor(ctx, in, info, handler)
}
